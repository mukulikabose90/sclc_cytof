...
png("figures/all_samples_ctcs_optimal_clusters.png", width = 12, height = 5, units = "in", res = 1200)
print(p1)
dev.off()


# Save figures
jpeg("figures/all_samples_ctcs_subtype_heatmap.jpg", width=200,height=100, units = "mm", res=1000)
...
# NAIVE SAMPLES
png("figures/all_samples_ctcs_naive_subtype_heatmap.png", width = 12, height = 5, units = "in", res = 1200)
# tiff("figures/ctcs_subtype_heatmap.tiff", width = 12, height = 5, units = "in", res = 1200)
draw(naive_ht)
# dev.off()
dev.off()
...
#TREATED SAMPLES
png("figures/all_samples_ctcs_treated_subtype_heatmap.png", width = 12, height = 5, units = "in", res = 1200)
# tiff("figures/ctcs_subtype_heatmap.tiff", width = 12, height = 5, units = "in", res = 1200)
draw(treated_ht)
# dev.off()
dev.off()
