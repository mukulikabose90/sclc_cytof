...
jpeg(glue("figures/ctcs_subtype_tf_expression_boxplot.jpg"), width=160,height=160, units = "mm", res=1000)
print(p1)
dev.off()

jpeg(glue("figures/ctcs_subtype_expression_boxplot.jpg"), width=260,height=260, units = "mm", res=1000)
print(p2)
dev.off()
