...
jpeg(glue("figures/cluster_{metric_to_use}_de_signif.jpg"), width=120,height=100, units = "mm", res=1000)
print(p1)
dev.off()

jpeg(glue("figures/cluster_{metric_to_use}_de_all.jpg"), width=120,height=100, units = "mm", res=1000)
print(p2)
dev.off()
